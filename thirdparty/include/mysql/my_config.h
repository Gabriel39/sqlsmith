...
#define DEFAULT_MYSQL_HOME "/var/local/incubator-doris/thirdparty/installed/mysql"
#define SHAREDIR "/var/local/incubator-doris/thirdparty/installed/mysql/share"
#define DEFAULT_BASEDIR "/var/local/incubator-doris/thirdparty/installed/mysql"
#define MYSQL_DATADIR "/var/local/incubator-doris/thirdparty/installed/mysql/data"
#define MYSQL_KEYRINGDIR "/var/local/incubator-doris/thirdparty/installed/mysql/keyring"
#define DEFAULT_CHARSET_HOME "/var/local/incubator-doris/thirdparty/installed/mysql"
#define PLUGINDIR "/var/local/incubator-doris/thirdparty/installed/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/var/local/incubator-doris/thirdparty/installed/mysql/etc"
